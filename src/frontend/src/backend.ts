...
export class Backend implements backendInterface {
    ...
    async getAllTributes(): Promise<Array<Tribute>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllTributes();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async leaveTribute(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.leaveTribute(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
